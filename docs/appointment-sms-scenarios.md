...
### Gets a post-visit text (~30 minutes after the visit)

Sent for everyone who opted into texts (cancel / no-show skip). If **Ask after next visit** is on, this same text also asks for a Google review and then turns the box off.

**SMS** — thank-you only (toggle off)
...
**SMS** — thank-you + review (toggle on)
...
| Client | ~30 min after visit | Thank-you (plus Google review ask if profile box on) |
