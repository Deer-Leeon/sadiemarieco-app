...
/** @typedef {'confirmation'|'reminder_48h'|'reminder_24h'|'reminder_1h'|'reschedule'|'admin_cancel'|'no_show_no_charge'|'no_show_charged'|'late_cancel_fee'|'no_show_free_pass_used'|'late_change_free_pass_used'|'no_show_free_pass_granted'|'late_change_free_pass_granted'|'client_cancel_early'|'client_cancel_late_no_fee'|'checkout_abandoned'|'feedback_day_after'} SmsTemplateKey */
