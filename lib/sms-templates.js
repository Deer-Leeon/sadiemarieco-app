...
/** @typedef {'confirmation'|'confirmation_visit'|'reminder_48h'|'reminder_24h'|'reminder_visit'|'visit_update'|'reschedule'|'admin_cancel'|'no_show_no_charge'|'no_show_charged'|'late_cancel_fee'|'no_show_free_pass_used'|'late_change_free_pass_used'|'no_show_free_pass_granted'|'late_change_free_pass_granted'|'consent_request'|'client_cancel_early'|'client_cancel_late_no_fee'|'checkout_abandoned'|'feedback_day_after'|'review_request'|'review_request_manual'} SmsTemplateKey */
...
const SMS_TEMPLATE_META = Object.freeze({
  confirmation: {
    ...
    defaultBody:
      "Confirmed! You've booked a {{service}} on {{date}} at {{time}}. You'll receive reminder messages with pre-arrival instructions before your appointment. I can't wait to see you! If there is any conflict, please cancel or reschedule with at least 24 hours' notice here: {{manageUrl}}.",
    sendingLive: true,
  },
  confirmation_visit: {
    title: 'Same-day visit confirmation',
    triggers: [
      'Client (or admin) confirms a second or later service on a day that already has a confirmed booking, before the pre-visit reminder has gone. Lists every service that day, one arrival time, and promises prep in the reminder. No lash/brow instructions in this text.',
    ],
    allowedPlaceholders: [
      'service',
      'date',
    ...
    requiredPlaceholders: ['manageUrl'],
    defaultBody:
      "Confirmed! {{date}}: {{visitServices}}. Please arrive at {{arrivalTime}}. You'll receive a reminder with pre-arrival instructions before your visit. I can't wait to see you! If there is any conflict, please cancel or reschedule with at least 24 hours' notice here: {{manageUrl}}.",
    sendingLive: true,
  },
  reminder_48h: {
    ...
    defaultBody:
      "Your {{service}} is in 2 days at {{time}}! Please come with clean brows and no makeup. For your skin's safety, avoid any products containing retinol or tretinoin until after your appointment. Feel free to bring earbuds with you. I'm so excited to see you!",
    sendingLive: true,
  },
  reminder_24h: {
    ...
    requiredPlaceholders: [],
    defaultBody:
      "Your {{service}} is tomorrow at {{time}}! Please come with clean lashes and no eye makeup. Please refrain from drinking caffeine for at least 4-6 hours before your appointment as it can cause fluttery eyelids. Feel free to bring earbuds with you. I'm so excited to see you!",
    sendingLive: true,
  },
  reminder_visit: {
    title: 'Same-day visit reminder',
    triggers: [
      'One pre-visit text for a client who has more than one confirmed booking that day. Sent 48 hours before arrival if any service is brows/teeth, otherwise 24 hours before arrival.',
    ],
    allowedPlaceholders: [
      'date',
      'time',
    ...
    requiredPlaceholders: [],
    defaultBody:
      "{{date}}: {{visitServices}}. Please arrive at {{arrivalTime}}. {{visitPrep}} Feel free to bring earbuds with you. I'm so excited to see you!",
    sendingLive: true,
  },
  visit_update: {
    title: 'Same-day visit update',
    triggers: [
      "The day's bookings changed after a prior multi-service confirmation or after the pre-visit reminder already went (another service booked, one cancelled, or one rescheduled). Corrects the lineup and arrival time, and includes a manage link for the booking that changed. {{visitPrep}} is real lash/brow instructions only if the reminder already went (no second reminder will fire); otherwise it promises those instructions in the upcoming reminder.",
    ],
    allowedPlaceholders: [
      'date',
      'time',
    ...
    requiredPlaceholders: ['manageUrl'],
    defaultBody:
      'Update: {{date}}: {{visitServices}}. Please arrive at {{arrivalTime}}. {{visitPrep}} If you need to cancel or reschedule: {{manageUrl}}.',
    sendingLive: true,
  },
  reschedule: {
    ...
    triggers: [
      ...
      'Promises prep in the 24h/48h reminder. No lash/brow instructions in this text.',
    ],
    allowedPlaceholders: ['service', 'date', 'time', 'visitPrep', 'manageUrl'],
    requiredPlaceholders: ['manageUrl'],
    defaultBody:
      "Your {{service}} has been rescheduled to {{date}} at {{time}}. You'll receive a reminder with pre-arrival instructions before your visit. I'm so excited to see you! Manage, reschedule, or cancel: {{manageUrl}}.",
    sendingLive: true,
  },
  admin_cancel: {
  ...
  // ── Formerly draft — now wired to send ─────────────────────────────────
  ...
  client_cancel_early: {
    ...
    requiredPlaceholders: [],
    defaultBody:
      'Your {{service}} on {{date}} at {{time}} has been canceled. I hope to see you again soon! Book anytime at {{siteUrl}}.',
    sendingLive: true,
  },
  client_cancel_late_no_fee: {
  ...
  feedback_day_after: {
    ...
    triggers: [
      'About 30 minutes after a confirmed visit ends, if the client opted into texts and “Ask after next visit” is off.',
    ],
    allowedPlaceholders: ['firstName', 'service', 'siteUrl'],
    requiredPlaceholders: [],
    defaultBody:
      'Hi {{firstName}}! Thank you for visiting Sadie Marie, I loved having you in! Book your next visit anytime: {{siteUrl}}.',
    sendingLive: true,
  },
  review_request: {
    title: 'Post-visit thank-you + Google review',
    triggers: [
      'About 30 minutes after a confirmed visit ends, if the client opted into texts and “Ask after next visit” is on.',
      'The profile checkbox turns off automatically after this text is sent. Recheck it to ask again after a later visit.',
    ],
    allowedPlaceholders: ['firstName', 'service', 'siteUrl', 'reviewUrl'],
    requiredPlaceholders: ['reviewUrl'],
    defaultBody:
      'Hi {{firstName}}! Thank you for visiting Sadie Marie, I loved having you in! Book your next visit anytime: {{siteUrl}}. If you have a moment, a Google review would mean the world: {{reviewUrl}}',
    sendingLive: true,
  },
  review_request_manual: {
    title: 'Google review request (manual)',
    triggers: [
      'Admin taps Send review text on a client profile. Does not name a service.',
      '“Ask after next visit” turns off after this text is sent. The automatic 30-minute text still goes as thank-you only (no second review ask).',
    ],
    allowedPlaceholders: ['firstName', 'reviewUrl'],
    requiredPlaceholders: ['reviewUrl'],
    defaultBody:
      'Hi {{firstName}}! If you have a moment, a Google review would mean the world: {{reviewUrl}}',
    sendingLive: true,
  },
});
...
const SAMPLE_PREVIEW_VARS = Object.freeze({
  ...
  visitServices:
    'Korean Lash Lift + Tint, then Lamination, Wax, + Tint at 12:30 pm',
  visitPrep:
    'For lashes: come with clean lashes and no eye makeup, and skip caffeine for at least 4-6 hours before. For brows: come with clean brows and no makeup, and skip retinol or tretinoin until after your appointment.',
  siteUrl: 'https://sadiemarie.co',
  firstName: 'Alex',
  consentUrl: 'https://sadiemarie.co/consent/00000000-0000-0000-0000-000000000001',
  reviewUrl: 'https://g.page/r/CQ0Tmk7shapREBM/review',
});
