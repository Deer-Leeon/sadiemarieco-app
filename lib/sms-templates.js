...
const SMS_TEMPLATE_META = Object.freeze({
  ...
  confirmation_visit: {
    ...
    triggers: [
      'Client (or admin) confirms a second or later service on a day that already has a confirmed booking. Leads with one arrival time.',
    ],
    allowedPlaceholders: [
      'service',
      'date',
    ...
    requiredPlaceholders: ['manageUrl'],
    defaultBody:
      "Confirmed! Please arrive {{date}} at {{arrivalTime}} for {{visitServices}}. {{visitPrep}} You'll receive a reminder with these details before your visit. I can't wait to see you! If there is any conflict, please cancel or reschedule with at least 24 hours' notice here: {{manageUrl}}.",
    sendingLive: true,
  },
  reminder_48h: {
  ...
  reminder_visit: {
    ...
    requiredPlaceholders: [],
    defaultBody:
      "Please arrive {{date}} at {{arrivalTime}} for {{visitServices}}. {{visitPrep}} Feel free to bring earbuds with you. I'm so excited to see you!",
    sendingLive: true,
  },
  visit_update: {
    title: 'Same-day visit update',
    triggers: [
      "The day's bookings changed after a confirmation or reminder already went out (another service booked, one cancelled, or one rescheduled). Corrects arrival time and remaining prep.",
    ],
    allowedPlaceholders: [
      'date',
      'time',
    ...
    requiredPlaceholders: [],
    defaultBody:
      'Update: please arrive {{date}} at {{arrivalTime}} for {{visitServices}}. {{visitPrep}}',
    sendingLive: true,
  },
  reschedule: {
...
const SAMPLE_PREVIEW_VARS = Object.freeze({
  ...
  visitServices:
    'Korean Lash Lift + Tint at 11:00 am, then Lamination, Wax, + Tint at 12:30 pm',
  visitPrep:
