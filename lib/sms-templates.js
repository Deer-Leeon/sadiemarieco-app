...
const SMS_TEMPLATE_META = Object.freeze({
  ...
  reminder_1h: {
    ...
    requiredPlaceholders: [],
    defaultBody:
      "Your {{service}} is in 1 hour! Please come with a clean face and no makeup. Feel free to bring earbuds with you. I'm so excited to see you!",
    sendingLive: true,
  },
  reschedule: {
  ...
  feedback_day_after: {
    ...
    triggers: [
      'System follow-up about 24 hours after a confirmed visit (QStash → /api/feedback).',
    ],
  ...
  review_request: {
    ...
    triggers: [
      'About 30 minutes after a confirmed visit ends, if the client opted into texts and “Ask for a Google review after their next visit” is on in their profile.',
      'The profile checkbox turns off automatically after this text is sent. Recheck it to ask again after a later visit.',
    ],
    allowedPlaceholders: ['firstName', 'service', 'reviewUrl'],
    requiredPlaceholders: ['reviewUrl'],
    defaultBody:
      'Hi {{firstName}}! I hope you loved your {{service}} today. If you have a moment, a Google review would mean the world: {{reviewUrl}}',
    sendingLive: true,
  },
  review_request_manual: {
    ...
    triggers: [
      ...
      '“Ask after next visit” turns off after this text is sent so the automatic 30-minute send does not go out too.',
    ],
