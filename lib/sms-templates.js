...
const SMS_TEMPLATE_META = Object.freeze({
  ...
  visit_update: {
    ...
    triggers: [
      "The day's bookings changed after the pre-visit reminder already went, or after a prior multi-service confirmation (another service booked, one cancelled, or one rescheduled). Corrects arrival time and remaining prep, and includes a manage link for the booking that changed.",
    ],
    allowedPlaceholders: [
      'date',
      'time',
  ...
  reschedule: {
    ...
    requiredPlaceholders: ['manageUrl'],
    defaultBody:
      "Your {{service}} has been rescheduled to {{date}} at {{time}}. {{visitPrep}} I'm so excited to see you! Manage, reschedule, or cancel: {{manageUrl}}. Msg frequency varies.",
    sendingLive: true,
  },
  admin_cancel: {
