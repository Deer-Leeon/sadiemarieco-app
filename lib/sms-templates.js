...
const SMS_TEMPLATE_META = Object.freeze({
  ...
  visit_update: {
    ...
    triggers: [
      "The day's bookings changed after the pre-visit reminder already went, or after a prior multi-service confirmation (another service booked, one cancelled, or one rescheduled). Corrects arrival time and remaining prep.",
    ],
    allowedPlaceholders: [
      'date',
      'time',
    ...
    requiredPlaceholders: [],
    defaultBody:
      'Update: {{date}}: {{visitServices}}. Please arrive at {{arrivalTime}}. {{visitPrep}}',
    sendingLive: true,
  },
  reschedule: {
