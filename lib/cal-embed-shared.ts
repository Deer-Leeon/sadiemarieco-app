 ...
 *
 * `dark` css vars intentionally mirror `light` so OS dark mode cannot
 * flip the embed to Cal's default black booker.
 */
...
const ADMIN_CAL_LIGHT_CSS_VARS = {
  'cal-brand': '#1c1917',
...
export const MANUAL_BOOKING_CAL_UI_CONFIG = {
  ...
  cssVarsPerTheme: {
    light: ADMIN_CAL_LIGHT_CSS_VARS,
    dark: ADMIN_CAL_LIGHT_CSS_VARS,
  },
};
